...
module.exports = async (pluginConfig, context) => {
    ...
    if (pluginConfig.registry && env.REGISTRY_USERNAME && env.REGISTRY_PASSWORD) {
        ...
        try {
            ...
            errors.push('Could not login to registry. Wrong credentials? USERNAME AND PASSWORD', error);
        }
        ...
        try {
            ...
            errors.push('Could not access S3 helm repo. Wrong credentials? KEY AND SECRET', error);
        } 
    }
